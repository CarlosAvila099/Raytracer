...
public class Intersection {
    ...
    /**
     * @param position the Vector3D representing the position of the Intersection.
     * @param distance a double value representing the distance between two objects.
     * @param normal the normal vector of the Intersection.
     * @param object the object that is intersected.
     */
