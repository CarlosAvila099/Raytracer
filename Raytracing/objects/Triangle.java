...
public class Triangle implements IIntersectable {
    ...
    /**
     * @param vertex1 upper vertex of the Triangle.
     * @param vertex2 left vertex of the Triangle.
     * @param vertex3 right vertex of the Triangle.
     */
     ...
     * @param vertex2 left vertex of the Triangle.
     * @param vertex3 right vertex of the Triangle.
     * @param normal1 normal for the upper vertex of the Triangle.
     * @param normal1 normal for the left vertex of the Triangle.
     * @param normal1 normal for the right vertex of the Triangle.
     */
    ...
    /**
     * @param vertices array having the vertices positions of the Triangle.
     * @param normal array having the normal vectors of the vertices of the Triangle.
     */
    ...
    /**
     * @param ray a Ray we are going to check if the Triangle intersects with.
     * @return the Intersection between the Triangle and a Ray.
